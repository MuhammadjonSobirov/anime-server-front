    ...
    return (
        <div>
            ...
            <footer className="bg-white dark:bg-gray-900">
                <div className="mx-auto w-full mt-20 max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Animarin™</a>. All Rights Reserved.
                        </span>
